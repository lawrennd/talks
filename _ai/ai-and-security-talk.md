...
subtitle: "Understanding the evolution of security challenges in the age of AI"
abstract: |
...
\include{_trent/includes/three-security-examples-opening.md}
\include{_trent/includes/bandwidth-security-implications.md}
\include{_trent/includes/ham-security-architecture.md}

\include{_trent/includes/classical-security-genai-enhancement.md}
\include{_trent/includes/genai-specific-security-challenges.md}

\include{_trent/includes/trent-security-progression.md}

\include{_trent/includes/information-systems-security-future.md}
