...
\include{_ai/includes/algal-bloom-information.md}
...
\newslide{Preserving the Ecology of the Human}

\slides{* Human culture is an ecology — complex, slow, irreplaceable
